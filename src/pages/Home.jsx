      ...
      <section className="work-preview-section section-padding relative-z">
        <div className="container">
          ...
          <div className="imac-projects-grid">
            {[
              { id: 1, title: 'Araw Supermarket', imageUrl: '/media/screencapture-arawsupermarket-gr-2025-12-09-16_58_26-scaled-e1765279408154.webp', liveUrl: 'https://arawsupermarket.gr' },
